...
})(["background-color:white;border-radius:8px;padding:36px;position:relative;height:100%;z-index:20;margin-top:48px;display:grid;grid-template-areas:'blurb portrait' 'current current';grid-template-columns:1fr 1fr;grid-column-gap:16px;grid-row-gap:16px;"]);
...
})(["grid-area:current;p{&:nth-of-type(even){margin-top:32px;}display:inline-block;letter-spacing:0.75px;color:#333333;font-size:18px;font-weight:300;line-height:21px;text-align:justify;}.bold{color:black;font-weight:700;font-size:17px;}"]);
...
//# sourceMappingURL=about.js.a2796fabed35b06a578a.hot-update.js.map