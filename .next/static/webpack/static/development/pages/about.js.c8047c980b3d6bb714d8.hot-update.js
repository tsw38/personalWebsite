...
})(["background-color:white;border-radius:8px;padding:24px 36px;position:relative;height:1900px;z-index:20;margin-top:48px;display:grid;grid-template-areas:'blurb portrait' 'description';grid-template-columns:1fr 1fr;grid-column-gap:16px;"]);
...
})(["height:400px;width:100%;padding-top:50%;background:url('/static/profile.png');background-size:cover;background-repeat:no-repeat;background-position:center;"]);
...
//# sourceMappingURL=about.js.c8047c980b3d6bb714d8.hot-update.js.map